...
eks_admin_rolename = 'Admin' # Set this to the Admin role in your AWS account, this is typically 'Admin'
trusted_registries = '1111111111111.dkr.ecr.us-east-1.amazonaws.com,busybox' # Example Container Registries
##########################################################################################################


app = App()
eks_stack = CdkConfigEksStack(app, 
    "eksconfigexample",
